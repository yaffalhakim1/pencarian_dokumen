...
function LoginForm(this: any) {
  ...
  async function handleLogin(e: any) {
    ...
    try {
      const loginReq = await axios.post("https://dummyjson.com/auth/login", {
        Headers: {
          ...
          <div className="flex justify-center items-center flex-wrap h-full g-6 text-gray-800">
            ...
            <div className="md:w-8/12 lg:w-5/12 lg:ml-20">
              <form onSubmit={handleLogin}>
                ...
                <a
                  className="px-7 py-3 text-black font-medium text-sm leading-snug uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out w-full flex justify-center items-center"
